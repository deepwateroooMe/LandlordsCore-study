namespace ETModel {
    public static partial class InnerOpcode {
        ...
        public const ushort DBSaveRequest = 1009; // 数据库操作
        ...
        public const ushort R2G_GetLoginKey = 1029; // 登录
        public const ushort G2R_GetLoginKey = 1030;
        public const ushort G2M_CreateUnit = 1031;
        public const ushort M2G_CreateUnit = 1032;
        public const ushort G2M_SessionDisconnect = 1033; // 会话框结束
        public const ushort G2R_PlayerOnline_Req = 1034; // 玩家上下线
        ...
        public const ushort R2G_PlayerKickOut_Req = 1040; // 玩家被踢下线
        public const ushort G2R_PlayerKickOut_Ack = 1041;
        
// 这里，更多的就是与当前游戏里场景，用到的相关的了，不具普通性
