...
// 先按照权重降序，再按花色升序
        ...
        public static bool IsStraight(IList<Card> cards) {
            if (cards.Count < 5 || cards.Count > 12) // 【5, 12】张牌
                return false;
